...
/****** Object:  Table [dbo].[Report_SalesForce_Criacao_Automatica]    Script Date: 04/04/2024 14:44:43 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Report_SalesForce_Criacao_Automatica](
...
CREATE TABLE [Report_SalesForce_Criacao_Manual]
(
	...
	[Nome_da_conta] [varchar](150) NULL,
	[Nome_da_oportunidade] [varchar](150) NULL,
	...
	[Descrição] [varchar](900) NULL,
	[Descrição_da_conta] [varchar](900) NULL,
...
EXEC sp_spaceused 'Report_SalesForce_Criacao_Manual'; 
...
INNER JOIN 
    sys.tables t ON ps.object_id = t.object_id
WHERE 
    t.name = 'Report_SalesForce_Criacao_Manual';
